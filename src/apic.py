...
#sys.path.append(os.path.join(os.path.dirname(__file__), "usr/lib/python3.14/site-packages"))
...
app_dir = Path(os.environ.get("XDG_DATA_HOME", Path.home()/".local/share")) / "apic"
